...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Fotógrafo profesional en Córdoba. Retratos, motor, eventos y paisajes con una mirada auténtica y editorial." },
      { name: "author", content: "Jose García" },
      { property: "og:title", content: "Jose García Photography" },
      { property: "og:description", content: "Retratos, motor, eventos y paisajes en Córdoba, España." },
